...
/**
  * Navbar component
  * 
  * @param loginDisplay - The username of the logged in user
  * @param onLoginClick - Function to handle login button click
  * @param onLogoutClick - Function to handle logout button click
